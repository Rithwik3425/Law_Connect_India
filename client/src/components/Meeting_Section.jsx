        ...
        <div className="container">
          <div className="d-flex flex-row">
            ...
            <img
              ...
              <h4>Meeting with: <span>Advocate Rajat Verma</span></h4>
              <h4>On: <span className="span-user">3rd February 2024</span></h4>
              <h4>Time: <span className="span-user">6:00 PM to 7:00 PM</span></h4>
            </div>
            ...
            <img
              ...
              <h4>Meeting with: <span>Advocate Rajat Verma</span></h4>
              <h4>On: <span className="span-user">25th January 2024</span></h4>
              <h4>Time: <span className="span-user">5:00 PM to 6:00 PM</span></h4>
            </div>
          ...
          {page === "upcoming" && <div>Upcoming Meetings
          <div className="meeting-con">
              <div className="center-con">
            <img
                src="https://img.freepik.com/premium-vector/lawyer-avatar-vector-illustration_822301-12.jpg"
          ...
          {page === "completed" && <div>Completed Meetings
          <div className="meeting-con">
              <div className="center-con">
            <img
                src="https://img.freepik.com/premium-vector/lawyer-avatar-vector-illustration_822301-12.jpg"
